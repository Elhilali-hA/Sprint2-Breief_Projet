...
<main class="first">
    ...
    <div class="f_background">
        <div class="opaback">
            <button id="b1">Continue with Facebook</button>
           <a href="login.php"><button id="b2">Continue with Gmail</button></a>
        </div>
    ...
    <footer class="foot">
        ...
        <div class="foot__button">
           ...
           <a href="login.php"> <button id="b2" >Login</button></a>
        </div>
    </footer>
    <main class="bac_img">
        <div class="back_img">
...
<main class="deliver">
    ...
    <main class="price">
        ...
        <p>azertyuioplkjhgfdsw;;bcytlkn</p>
    </div>
</main>
